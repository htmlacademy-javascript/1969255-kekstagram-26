...
function checkFormValidity() {
  pristine.addValidator(
    ...
    'Хэштег начинается с символа # (решётка) <br> Строка после решётки должна состоять из букв и чисел <br> Хештег не может состоять только из одной решётки <br> Максимальная длина одного хэштега 20 символов, включая решётку'
  );
